...
MILESTONE_REGEX = "https://github.com/apecloud/kbcli/milestone/([0-9]+)"
...
def main(argv: list[str]) -> None:
    ...
    issues = [
        i
        for i in gh.get_repo("apecloud/kbcli").get_issues(state="open")
    ...
    repo = gh.get_repo(f"apecloud/kbcli")
