---
title: kbcli cluster create testredis
---

Create a testredis cluster.

```
kbcli cluster create testredis NAME [flags]
```
...
```
  ...
  kbcli cluster create testredis
  
  # Create a cluster with the specified cpu, memory and storage
  kbcli cluster create testredis --cpu 1 --memory 2 --storage 10
```
